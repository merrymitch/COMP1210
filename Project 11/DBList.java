...
public class DBList {
         ...
         try {
            ...
            switch (type) {
               ...
               case 'E':
                  ...
                  break;
               default:
                  String category = Character.toString(type);
                  throw new InvalidCategoryException(category);
            }
         }
         catch (NumberFormatException e) {
            String resultError = dbLine + "\n" + e;
            addInvalidRecord(resultError);
         }
   ...
   /**
    * Processes invalid records array to produce the Invalid Records
    * Report and then returns report as a string. 
    *
    * @return String of the invalid records report.
    */
