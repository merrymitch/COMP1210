...
public class Spherocylinder implements Comparable<Spherocylinder> {
   ...
   /** 
    * Accepts spherocylinder object and returns negative if this.volume()
    * is less than parameter volume, a positive if this.volume() is 
    * greater than parameter, zero if they are equal.
    *
    * @param obj spherocylinder to be compared.
